...
if (!process.env.API_KEY) {
  ...
  // For this context, we'll throw an error to make the issue clear.
  throw new Error("API_KEY environment variable not set. Please ensure it is configured in the execution environment.");
}
